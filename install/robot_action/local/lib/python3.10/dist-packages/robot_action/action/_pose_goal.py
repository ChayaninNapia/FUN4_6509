    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_action.action.PoseGoal_Goal')
            logger.debug(
...
class PoseGoal_Goal(metaclass=Metaclass_PoseGoal_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.task = array.array('d', kwargs.get('task', []))
    ...
    def task_type(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'task_type' field must be an integer in [-32768, 32767]"
    ...
    def task(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'task' array.array() must have the type code of 'd'"
            self._task = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'task' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._task = array.array('d', value)
...
class Metaclass_PoseGoal_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_action.action.PoseGoal_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_PoseGoal_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_action.action.PoseGoal_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PoseGoal_SendGoal_Request(metaclass=Metaclass_PoseGoal_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robot_action/PoseGoal_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_action', 'action'], 'PoseGoal_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_action.action._pose_goal import PoseGoal_Goal
...
class Metaclass_PoseGoal_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_action.action.PoseGoal_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_action.action import _pose_goal
...
class PoseGoal_SendGoal(metaclass=Metaclass_PoseGoal_SendGoal):
    from robot_action.action._pose_goal import PoseGoal_SendGoal_Request as Request
    from robot_action.action._pose_goal import PoseGoal_SendGoal_Response as Response
...
class PoseGoal_GetResult_Response(metaclass=Metaclass_PoseGoal_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robot_action/PoseGoal_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_action', 'action'], 'PoseGoal_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_action.action._pose_goal import PoseGoal_Result
...
class Metaclass_PoseGoal_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_action.action.PoseGoal_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PoseGoal_GetResult(metaclass=Metaclass_PoseGoal_GetResult):
    from robot_action.action._pose_goal import PoseGoal_GetResult_Request as Request
    from robot_action.action._pose_goal import PoseGoal_GetResult_Response as Response
...
class Metaclass_PoseGoal_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_action.action.PoseGoal_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PoseGoal_FeedbackMessage(metaclass=Metaclass_PoseGoal_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robot_action/PoseGoal_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_action', 'action'], 'PoseGoal_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robot_action.action._pose_goal import PoseGoal_Feedback
...
class PoseGoal(metaclass=Metaclass_PoseGoal):
    ...
    from robot_action.action._pose_goal import PoseGoal_Goal as Goal
    # The result message defined in the action definition.
    from robot_action.action._pose_goal import PoseGoal_Result as Result
    # The feedback message defined in the action definition.
    from robot_action.action._pose_goal import PoseGoal_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robot_action.action._pose_goal import PoseGoal_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robot_action.action._pose_goal import PoseGoal_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robot_action.action._pose_goal import PoseGoal_FeedbackMessage as FeedbackMessage
