...
class Metaclass_ChangeMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_action.srv import _change_mode
...
class ChangeMode(metaclass=Metaclass_ChangeMode):
    from robot_action.srv._change_mode import ChangeMode_Request as Request
    from robot_action.srv._change_mode import ChangeMode_Response as Response
