...
class RobotServerNode(Node):
    def __init__(self):
        ...
        self.publisher_random= self.create_publisher(PoseStamped, '/target', 10)
    ...
    def call_random_to_ikine(self):
        ...
        self.publisher_random.publish(self.old_target)
    ...
    def handle_response(self, future):
        try:
            ...
            self.old_target = response.taskspace
    ...
    def convert_to_ps(self, x, y, z):
        ...
        self.publisher_random.publish(msg)
