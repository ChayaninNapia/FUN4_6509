...
#ifndef CUSTOM_INTERFACE__SRV__DETAIL__SET_TASKSPACE__FUNCTIONS_H_
#define CUSTOM_INTERFACE__SRV__DETAIL__SET_TASKSPACE__FUNCTIONS_H_
 ...
 * calls
 * custom_interface__srv__SetTaskspace_Request__init().
...
/**
 * It calls
 * custom_interface__srv__SetTaskspace_Request__fini()
 ...
 * custom_interface__srv__SetTaskspace_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_interface__srv__SetTaskspace_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interface__srv__SetTaskspace_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interface
...
/**
 * It calls
 * custom_interface__srv__SetTaskspace_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interface
...
/**
 * It allocates the memory for the array and calls
 * custom_interface__srv__SetTaskspace_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interface
...
/**
 * It calls
 * custom_interface__srv__SetTaskspace_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACE__SRV__DETAIL__SET_TASKSPACE__FUNCTIONS_H_
