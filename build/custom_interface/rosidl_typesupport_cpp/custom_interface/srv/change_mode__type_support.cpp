...
static const _ChangeMode_Request_type_support_symbol_names_t _ChangeMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, srv, ChangeMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, srv, ChangeMode_Request)),
  }
};
...
{
  return &::custom_interface::srv::rosidl_typesupport_cpp::ChangeMode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interface, srv, ChangeMode_Request)() {
  return get_message_type_support_handle<custom_interface::srv::ChangeMode_Request>();
}
...
static const _ChangeMode_Response_type_support_symbol_names_t _ChangeMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, srv, ChangeMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, srv, ChangeMode_Response)),
  }
};
...
{
  return &::custom_interface::srv::rosidl_typesupport_cpp::ChangeMode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interface, srv, ChangeMode_Response)() {
  return get_message_type_support_handle<custom_interface::srv::ChangeMode_Response>();
}
...
static const _ChangeMode_type_support_symbol_names_t _ChangeMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interface, srv, ChangeMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interface, srv, ChangeMode)),
  }
};
...
{
  return &::custom_interface::srv::rosidl_typesupport_cpp::ChangeMode_service_type_support_handle;
}
