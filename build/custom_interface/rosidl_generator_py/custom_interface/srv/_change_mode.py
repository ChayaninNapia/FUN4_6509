...
class Metaclass_ChangeMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interface.srv.ChangeMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interface.srv import _change_mode
...
class ChangeMode(metaclass=Metaclass_ChangeMode):
    from custom_interface.srv._change_mode import ChangeMode_Request as Request
    from custom_interface.srv._change_mode import ChangeMode_Response as Response
