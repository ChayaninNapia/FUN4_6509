...
#ifndef ROBOT_ACTION__SRV__DETAIL__GEN_TARGET__FUNCTIONS_H_
#define ROBOT_ACTION__SRV__DETAIL__GEN_TARGET__FUNCTIONS_H_
...
/// Initialize srv/GenTarget message.
/**
...
/// Finalize srv/GenTarget message.
/**
...
/// Create srv/GenTarget message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_action__srv__GenTarget_Request__init().
...
/// Destroy srv/GenTarget message.
/**
 * It calls
 * robot_action__srv__GenTarget_Request__fini()
...
/// Check for srv/GenTarget message equality.
/**
...
/// Initialize array of srv/GenTarget messages.
/**
...
/// Finalize array of srv/GenTarget messages.
/**
 * It calls
 * robot_action__srv__GenTarget_Request__fini()
...
/// Create array of srv/GenTarget messages.
/**
 * It allocates the memory for the array and calls
 * robot_action__srv__GenTarget_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GenTarget messages.
/**
 * It calls
 * robot_action__srv__GenTarget_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GenTarget message array equality.
/**
...
/// Copy an array of srv/GenTarget messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_action__srv__GenTarget_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_action
...
/**
 * It calls
 * robot_action__srv__GenTarget_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_action
...
/**
 * It allocates the memory for the array and calls
 * robot_action__srv__GenTarget_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_action
...
/**
 * It calls
 * robot_action__srv__GenTarget_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_ACTION__SRV__DETAIL__GEN_TARGET__FUNCTIONS_H_
