...
#include "robot_action/srv/detail/change_mode__rosidl_typesupport_fastrtps_c.h"
...
using _ChangeMode_Request__ros_msg_type = robot_action__srv__ChangeMode_Request;
...
size_t get_serialized_size_robot_action__srv__ChangeMode_Request(
  const void * untyped_ros_message,
...
static uint32_t _ChangeMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_action__srv__ChangeMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_action
size_t max_serialized_size_robot_action__srv__ChangeMode_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_action__srv__ChangeMode_Request;
    is_plain =
      (
...
static size_t _ChangeMode_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_action__srv__ChangeMode_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_action, srv, ChangeMode_Request)() {
...
using _ChangeMode_Response__ros_msg_type = robot_action__srv__ChangeMode_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_action
size_t get_serialized_size_robot_action__srv__ChangeMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ChangeMode_Response__ros_msg_type * ros_message = static_cast<const _ChangeMode_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_action__srv__ChangeMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_action
size_t max_serialized_size_robot_action__srv__ChangeMode_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_action__srv__ChangeMode_Response;
    is_plain =
      (
...
static size_t _ChangeMode_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_action__srv__ChangeMode_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_action, srv, ChangeMode_Response)() {
...
// already included above
// #include "robot_action/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robot_action/srv/change_mode.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_action, srv, ChangeMode)() {
