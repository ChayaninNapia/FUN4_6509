...
static const _SetTaskspace_Request_type_support_symbol_names_t _SetTaskspace_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_action, srv, SetTaskspace_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_action, srv, SetTaskspace_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_action, srv, SetTaskspace_Request)() {
  return &::robot_action::srv::rosidl_typesupport_c::SetTaskspace_Request_message_type_support_handle;
}
...
static const _SetTaskspace_Response_type_support_symbol_names_t _SetTaskspace_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_action, srv, SetTaskspace_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_action, srv, SetTaskspace_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_action, srv, SetTaskspace_Response)() {
  return &::robot_action::srv::rosidl_typesupport_c::SetTaskspace_Response_message_type_support_handle;
}
...
static const _SetTaskspace_type_support_symbol_names_t _SetTaskspace_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_action, srv, SetTaskspace)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_action, srv, SetTaskspace)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robot_action, srv, SetTaskspace)() {
  return &::robot_action::srv::rosidl_typesupport_c::SetTaskspace_service_type_support_handle;
}
